...
# Mengambil API Key Gemini dan JSON Google Cloud dari Streamlit Secrets
try:
    ...
    if user_input:
        try:
            ...
            with st.spinner("Google Cloud sedang mengisi suara..."):
                ...
                # Tombol Download
                st.download_button(
                    label="📥 Unduh File Audio (MP3)",
                    data=response_audio.audio_content,
                    file_name="hasil_voiceover.mp3",
                    mime="audio/mp3"
                )
...
st.divider()
st.caption("Aplikasi ini menggunakan teknologi AI Gemini 1.5 Flash dan Google Cloud Neural2 Voices.")
