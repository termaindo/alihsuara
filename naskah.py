...
PENTING SECARA TEKNIS: Kamu WAJIB membungkus naskah final ini di dalam format Markdown Code Block (gunakan tiga simbol backtick di awal dan akhir naskah).
Contoh penulisanmu nanti harus seperti ini:
(tulis tiga backtick)text
Isi naskah Anda diletakkan di sini agar mudah disalin...
(tulis tiga backtick)

Tujuannya agar sistem dapat memunculkan tombol "Copy" secara otomatis. Pastikan HANYA teks naskah yang masuk ke dalam kotak kode tersebut. Gunakan tanda koma dan titik yang jelas untuk panduan napas.
    """
    ...
    # ==========================================
        ...
        if not st.session_state.hasil_naskah:
            ...
            st.warning("⚠️ **JANGAN LUPA:** Silakan klik ikon **Copy (Salin)** di pojok kanan atas pada kotak naskah di bawah ini, sebelum Anda beralih ke Studio Rekaman.")
